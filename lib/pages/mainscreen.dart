...
class Mainscreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: _buildBody(activeUrl, errorMessage, ref, securityState, isGhost, activeTab.id, primaryAccent),
      ),
    );
  }

  Widget _buildBody(String activeUrl, String? errorMessage, WidgetRef ref, SecurityState securityState, bool isGhost, String tabId, Color accent) {
    if (activeUrl.isEmpty) {
  ...
  // UPDATED DRAWER with embedded Theme Selector
    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: [
          ...
          // NEW: EMBEDDED THEME SELECTOR IN DRAWER
          if (!isGhost) 
            Padding(
